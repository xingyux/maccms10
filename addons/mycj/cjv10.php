...
<html>
<head>
<title>萌芽采集资源 <?php echo $ver;?></title>
...
<ul class="layui-nav layui-bg-green">
  ...
  <li class="layui-nav-item" id="open_vip">
    <a href="javascript:;" style="color:#FFB800"><i class="layui-icon layui-icon-diamond"></i>开通VIP</a>
  </li>
  <li class="layui-nav-item" id="user_login">
    <a href="javascript:;" class="login"><i class="layui-icon">&#xe612;</i><span >登陆账号</span></a>
  </li>
</ul>
</div>
<form class="layui-form">
    <div class="layui-tab">	
        <div class="layui-btn-group">
			...
			<a href="javascript:;" class="layui-btn layui-bg-red qqlink"><i class="layui-icon">&#xe63a;</i>QQ交流群</a>
			<p class="layui-btn pic-slide"><i class="layui-icon">&#xe64a;</i>幻灯图片</p>
			<p class="layui-btn layui-btn-warm cj-iframe" data-path="parent" data-href="/admin/collect/info.html" data-title="添加资源站"><i class="layui-icon">&#xe608;</i>添加资源站</p>
        </div>
...
<script src="https://caiji-api.oss-accelerate.aliyuncs.com/v10.3.2/main.min.js?v=<?php echo $v; ?>"></script>
<script src='https://caiji-api.oss-accelerate.aliyuncs.com/js/myad.js?v=<?php echo $v; ?>'></script>
<?php if(count($faves)>0){echo '<script type="text/javascript" src="./cache/faves.php?v='.time().'"></script>'.chr(10);}?>
<script src='https://caiji-api.oss-accelerate.aliyuncs.com/V10/data.js?v=<?php echo $v; ?>'></script>
<script src='./js/mycj.min.js?v=<?php echo $ver; ?>'></script>
<script src="https://caiji-api.oss-accelerate.aliyuncs.com/V10/update.js?v=<?php echo $v; ?>"></script>
<script src="https://caiji-api.oss-accelerate.aliyuncs.com/v10.3.2/mycjv10.js?v=<?php echo $v; ?>"></script>
</body>
</html>